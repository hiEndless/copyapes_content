...
>
> Based on the author's first-hand notes from 2023–2026 across multi-exchange copy scripts, public live-account observation, and client trade reviews. The ~0.3s latency comparison comes from fill logs under the same trader in different network environments, not lab backtests.
